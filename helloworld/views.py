...
def index(request):
	...
	imgurl = ["https://images.genius.com/68159643d424fa1e7195d00dabe9acb9.800x800x1.jpg", "https://images.genius.com/" \
              ...
              "4bb7757aa56dd965aac02554861b6768c", "https://pbs.twimg.com/media/DOTjQsRV4AAt1wP.jpg:large", "https://" \
              "images.genius.com/1e70431143ad8a020a261085aa669c35.1000x1000x1.jpg", "https://ssle.ulximg.com/image/75" \
    ...
    randomimglist = []
    for i in range(7):
        for ii in range(len(imgurls)):
            if ii not in randomimglist:
                randomimglist += ii
    for randomimg in range(len(randomimglist)):
        randomimglist[randomimg] = imgurls[randomimglist[randomimg]]
